        ...
        switch (title.toLowerCase()) {
            case "intern":
                defaultDescrition = "Интерн Java-разработчик — это начинающий специалист,\n" +
                        ...
                        "Обычно такие позиции предназначены для студентов или недавних выпускников, \n" +
                        "которые хотят получить практический опыт и развить свои навыки в реальных проектах.";
                break;
            case "junior":
                defaultDescrition = "Джуниор Java разработчик — это начинающий специалист в области программирования,\n" +
                        ...
                        " Данная роль подходит для выпускников вузов, студентов или людей,\n" +
                        " начинающих свою карьеру в IT, и предполагает выполнение базовых задач в рамках разработки программного обеспечения";
                break;
            case "junior+":
                defaultDescrition = "Джуниор+ Java разработчик — это специалист, который находится на промежуточной стадии\n" +
                        ...
                        "Обычно такие разработчики уже обладают некоторым опытом работы,\n" +
                        "знанием практических аспектов программирования и уверенным пониманием основ Java и сопутствующих технологий.\n";
                break;
            case "middle":
                defaultDescrition = "Миддл Java разработчик — это специалист со средним уровнем опыта в разработке программного обеспечения на языке Java.\n" +
                        ...
                        "Миддл разработчик часто участвует в проектировании и архитектуре приложений,\n" +
                        "а также может брать на себя определенные роли в рамках команды.\n";
                break;
            case "middle+":
